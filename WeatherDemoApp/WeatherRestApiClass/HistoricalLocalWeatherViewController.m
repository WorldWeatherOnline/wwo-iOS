//
//  HistoricalLocalWeatherViewController.m
//  WeatherRestApiClass
//
...
@interface HistoricalLocalWeatherViewController ()
...
@implementation HistoricalLocalWeatherViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (indexPath.section) {
        case 0:{
            ...
            cell.contentLbl.text = @"Historical Local Weather API";
            return cell;
        }
        case 1:{
            CommonTableViewCell *cell = (CommonTableViewCell *)[tableView dequeueReusableCellWithIdentifier:@"commonCell"];
        ...
        case 2:{
            if (indexPath.row == 0) {
                ...
                if (cell == nil) {
                    ...
                    cell.secondTitleLbl.text = @"Sunhour";
                    cell.thirdTitleLbl.text = @"UvIndex";
                }
                return cell;
            }
            else{
                ...
                if (cell == nil) {
                    ...
                    cell.maxTemp.text = [[self.weatherArray objectAtIndex:indexPath.row - 1] objectForKey:@"sunHour"];
                    cell.minTemp.text = [[self.weatherArray objectAtIndex:indexPath.row - 1] objectForKey:@"uvIndex"];
                }
                return cell;
            }
        }
